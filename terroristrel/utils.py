...
def set_mask(data: Data):
    ...
    for idx, i in enumerate(data.y):
        ...
        if i == 1:
            sample_patience += 1
            if sample_patience % 4 == 0and train_sample_patience % 8 != 0:
                train_mask[idx] = True
            if sample_patience % 4 == 1and train_sample_patience % 8 == 0:
                test_mask[idx] = True
