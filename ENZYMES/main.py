...
parser.add_argument('--dataset', type=str, default='ENZYMES295', help='ENZYMES 118/123/295/296/297')
...
parser.add_argument('--hgcn_construct_type', type=str, default='node_connection', help='model type')
...
def main():
    acc_list = list()
    logger = get_logger(f'./log_file/{args.hgcn_construct_type}_{args.dataset}_{args.model_type}.log')
