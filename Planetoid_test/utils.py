...
def construct_hypergraph(edge_index, num_nodes, construct_type,args):
    ...
    torch.save(hyperedge_index,f'hyperedge_index_{args.dataset}_{args.hgcn_construct_type}.pt')
